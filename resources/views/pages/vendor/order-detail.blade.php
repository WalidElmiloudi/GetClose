        ...
        <div class="max-w-7xl mx-auto">
            <div class="mb-8">
                <a href="{{ route('vendor.orders') }}"
                    class="text-red-600 hover:text-red-700 font-semibold mb-4 inline-block">
                    ← Back to Orders
                </a>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            @if ($vendorItems->count() > 0)
                                @foreach ($vendorItems as $item)
                                    <div class="flex items-center gap-4 pb-4 border-b border-gray-100 last:border-0">
                                        <div
                                            class="h-20 w-20 bg-gradient-to-b from-red-100 to-red-200 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div class="lg:col-span-1 space-y-6">
                    <!-- Replace status dropdown with read-only badge -->
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <div class="bg-gray-100 border-2 border-gray-300 rounded-lg p-4">
                            ...
                            <span
                                class="inline-block mt-2 px-4 py-2 rounded-full text-sm font-semibold
            ...
            @else bg-blue-100 text-blue-700 @endif">
                            ...
                            <p class="text-xs text-gray-500 mt-2">
                                <i class="ph-fill ph-lock-key"></i> Only administrators can update order status
                            </p>
                        </div>
                    </div>
