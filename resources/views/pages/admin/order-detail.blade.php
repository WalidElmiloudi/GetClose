...
<main class="w-full min-h-screen bg-gradient-to-b from-red-50 to-white py-10 px-4 lg:px-30">
    <div class="max-w-7xl mx-auto">
        <div class="mb-8">
            <a href="{{ route('admin.orders') }}" class="text-red-600 hover:text-red-700 font-semibold mb-4 inline-block">
                ← Back to Orders
            </a>
                    ...
                    <div class="space-y-3">
                        ...
                        @if($order->payment)
                            ...
                            <div>
                                ...
                                <p class="font-mono text-sm text-gray-800">{{ $order->payment->transaction_id }}</p>
                            </div>
                        @endif
                    </div>
                </div>
